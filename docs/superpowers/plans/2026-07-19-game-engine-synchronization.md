...
- `docs/superpowers/specs/2026-07-19-game-engine-conductor-design.md` (conductor reconciliation: reserve control space to avoid covering the dashboard, dialogue and player)
...
- [x] Commit corrected code as `9268bfe7f72da557bcbd725a0d4489af9bb8f653` and pass its exact clean-code gates, including visible turret-hint separation at both required sizes. Evidence-SHA closure requires the matching PASS gate/review manifest linked by the dated handoff; the general closure protocol remains mandatory.
...
- [x] Keep Atlas list focus during selection changes; update details without stealing it. Preserve contact Tab access when the plotted target is outside the list, keep route selection unchanged on focus, and use the focused contact as the arrow origin.
...
- [x] Commit B3 runtime and corrections as `6206698`, `14b212c`, `e6e3946` and `09180a9`, and pass the latter exact clean-code gates. Evidence-SHA closure still requires the matching PASS gate/review manifest linked by the dated handoff; the general closure protocol remains mandatory.
