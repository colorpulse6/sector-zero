...
Evidence root: `/Users/nichalasbarnes/.codex/visualizations/2026/09/05/01a07127-3e6a-7ae1-b54b-436d683ef1c1/sector-zero-b3-evidence`. Exact gates and receipt identities are in `entry-code-gates.json`, `entry-code-receipt-verification.json`, followed by `evidence-gates.json` and `evidence-receipt-verification.json`. The final manifest owns the evidence-SHA and sequential-review verdict.
